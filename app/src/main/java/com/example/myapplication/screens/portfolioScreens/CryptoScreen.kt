...
fun CryptoScreen(
    ...
    val onDelete: (Investment) -> Unit = { investment ->
        viewModel.deleteCrypto(investment)
    }
    ...
    Scaffold(
        ...
        topBar = {
            AppTopBar(
                title = stringResource(R.string.portfolio_kryptomien),
        ...
        floatingActionButton = {
            FloatingActionButton(
                onClick = {navController.navigate(Screens.AddCryptoScreen.name) },
...
fun InvestmentBody(
    ...
    val investments = cryptoUiState.cryptos
